/*
 * FreeModbusPlus Libary: 注册回调函数，并通过回调操作写入和读出的数据
 ...
 *
 * File: $Id: user_mb1_app.c,v 1.0 2020/01/13 rainbowyu $
 */
...
static const char MBName[] = "mb1rtu";
static const ULONG conPin = 103;

BOOL
eMBUserInitApp1( eMBControlBlockSlave* peConBlock ){
